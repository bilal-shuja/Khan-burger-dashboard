  ...
  const DisplayRecord = () => {
    if (date !== null || contact !== null) {
      ...
      return (
        ...
        showRecord.sort((a, b) =>new Date(...b.DateTime.split("/").reverse())-new Date(...a.DateTime.split("/").reverse()))
              ...
              <div className="col-lg-12">
                <div className="card ">
                  <div className="card-header">
                    <h3 className="card-title bg-cover">Delivery Sales Record</h3>
                    <br />
                  </div>
                    ...
                    <table
                      ...
                      <thead>
                        ...
                        <tr>
                          ...
                          {admin === 'Admin' ?<th>Update Order Food Item</th>:null}
