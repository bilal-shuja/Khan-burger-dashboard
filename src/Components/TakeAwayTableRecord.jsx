...
const TakeAwayTableRecord = () => {
  ...
  const fetchOrder = () => {
    axios
      .get("https://api.khannburger.com/TakeAwayRecord.php")
      .then((res) => {
        setRecord(res.data);
              ...
              <div className="col-lg-12">
                <div className="card ">
                  <div className="card-header">
                    <h3 className="card-title bg-cover">Take Away Sales Record</h3>
                    <br />
                  </div>
...
export default TakeAwayTableRecord;
